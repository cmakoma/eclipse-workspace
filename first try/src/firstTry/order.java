...
public class order extends JFrame {
	...
	public order() {
		...
		Image burgerIcon1 = new ImageIcon(order.class.getResource("/firstTry/burgerChicken.png")).getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT);
		Image burgerIcon2 = new ImageIcon(order.class.getResource("/firstTry/burgerCheeseBurger.png")).getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT);
		...
		JLabel sodaPrice2 =  new JLabel("Mango: 0.99");
		...
		JLabel dessertPrice4 =  new JLabel("Blueberry: 32.99");
